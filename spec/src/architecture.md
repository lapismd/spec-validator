...
- `defineConfig` MUST compose typed configuration fragments, including exact repository-layout entries and table acceptance-detail policy, and neutral profiles MUST provide reusable defaults without embedding repository policy.
