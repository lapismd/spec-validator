...
| SV-ARCH-004 | In progress | `pnpm-workspace.yaml`; package manifest checks                      |
| SV-CFG-001  | In progress | `src/config.ts`; `src/profiles.ts`                                  |
| SV-CFG-002  | Implemented | `src/config.ts`; `src/commands/validate.ts`                         |
| SV-CFG-003  | In progress | diagnostic resolution and config tests                              |
| SV-CFG-004  | In progress | repository-owned consumer configs; `CONSUMER_MIGRATION.md`          |
| SV-VAL-001  | In progress | `src/validators/*.ts`                                               |
| SV-VAL-002  | Implemented | `src/commands/list.ts`; validator options                           |
| SV-VAL-003  | In progress | configurable validator tests and consumer fixtures                  |
